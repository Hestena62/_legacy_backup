...
<body class="light antialiased font-sans overflow-x-hidden selection:bg-primary selection:text-white" hx-boost="true" hx-indicator=".scroll-progress-bar">
