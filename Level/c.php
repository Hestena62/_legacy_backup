...
$pageTitle       = "1st Grade Level C | Hesten'S Learning";
$pageDescription = "Strong foundation in literacy, base-ten math, and observational science.";
$pageKeywords    = "1st grade, math, reading, science, social studies";
...
<header class="relative bg-gradient-to-br from-teal-600 via-emerald-600 to-teal-700 text-white py-16 px-4 mb-12 overflow-hidden rounded-b-[2.5rem] shadow-xl">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none opacity-20">
        ...
        <i class="fas fa-pencil-alt absolute top-10 left-10 text-9xl animate-pulse text-white/10"></i>
    ...
    <div class="container mx-auto text-center relative z-10">
        ...
        <p class="text-lg md:text-xl text-white/90 max-w-2xl mx-auto font-light leading-relaxed mb-8">
            Strong foundation in literacy, base-ten math, and observational science.
        </p>
        ...
        <div class="max-w-4xl mx-auto">
            <div id="content-math" class="tab-content block animate-fade-in-up">
                <div class="prose prose-lg dark:prose-invert max-w-none">
                    <h4 class="text-xl font-bold mb-4">Core Subjects & Standards</h4><div class="space-y-4"><div><h5 class="text-lg font-bold text-primary mb-1">Math</h5><p class="text-text-secondary">Sums and differences to 20, place value foundations (tens/ones).<br><span class="text-xs font-bold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700">CCSS.MATH.CONTENT.1.OA.A.1</span></p></div><div><h5 class="text-lg font-bold text-primary mb-1">ELA</h5><p class="text-text-secondary">Decoding regularly spelled one-syllable words, reading comprehension.<br><span class="text-xs font-bold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700">CCSS.ELA-LITERACY.RF.1.3</span></p></div><div><h5 class="text-lg font-bold text-primary mb-1">Science</h5><p class="text-text-secondary">Light and sound wave properties, celestial patterns.<br><span class="text-xs font-bold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700">NGSS: 1-PS4-1</span></p></div><div><h5 class="text-lg font-bold text-primary mb-1">Social Studies</h5><p class="text-text-secondary">Cultural traditions, geographic mapping, economic choices.<br><span class="text-xs font-bold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700">NCSS.D2.His.2.K-2</span></p></div></div>
                </div>
            </div>
