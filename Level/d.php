...
$pageDescription = "Fluency in addition and subtraction, understanding place value to 1,000.";
$pageKeywords    = "2nd grade, math, reading, science, social studies";
...
<header class="relative bg-gradient-to-br from-teal-600 via-emerald-600 to-teal-700 text-white py-16 px-4 mb-12 overflow-hidden rounded-b-[2.5rem] shadow-xl">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none opacity-20">
        ...
        <i class="fas fa-plus-minus absolute top-10 left-10 text-9xl animate-pulse text-white/10"></i>
        <i class="fas fa-leaf absolute bottom-10 right-10 text-8xl animate-spin-slow text-white/10" style="animation-duration: 12s;"></i>
    ...
    <div class="container mx-auto text-center relative z-10">
        ...
        <p class="text-lg md:text-xl text-white/90 max-w-2xl mx-auto font-light leading-relaxed mb-8">
            Fluency in addition and subtraction, understanding place value to 1,000.
        </p>
        ...
        <div class="max-w-4xl mx-auto">
            <div id="content-math" class="tab-content block animate-fade-in-up">
                <div class="prose prose-lg dark:prose-invert max-w-none">
                    <h4 class="text-xl font-bold mb-4">Core Subjects & Standards</h4><div class="space-y-4"><div><h5 class="text-lg font-bold text-primary mb-1">Math</h5><p class="text-text-secondary">Addition/Subtraction within 100, place value to 1,000, foundations of multiplication.<br><span class="text-xs font-bold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700">CCSS.MATH.CONTENT.2.OA.B.2</span></p></div><div><h5 class="text-lg font-bold text-primary mb-1">ELA</h5><p class="text-text-secondary">Decoding multi-syllable words, summarizing key points, rhythmic language.<br><span class="text-xs font-bold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700">CCSS.ELA-LITERACY.RL.2.4</span></p></div><div><h5 class="text-lg font-bold text-primary mb-1">Science</h5><p class="text-text-secondary">Plant needs, animal diversity in different habitats.<br><span class="text-xs font-bold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700">NGSS: 2-LS4-1</span></p></div><div><h5 class="text-lg font-bold text-primary mb-1">Social Studies</h5><p class="text-text-secondary">Government functions, hero narratives, environmental impact.<br><span class="text-xs font-bold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700">NCSS.D2.Civ.2.K-2</span></p></div></div>
                </div>
            </div>
