...
$pageTitle       = "3rd Grade Level E | Hesten's Learning";
$pageDescription = "Mastering multiplication, division, and complex sentence structures.";
$pageKeywords    = "3rd grade, math, division, fractions, reading comprehension";
...
<header class="relative bg-gradient-to-br from-teal-600 via-emerald-600 to-teal-700 text-white py-16 px-4 mb-12 overflow-hidden rounded-b-[2.5rem] shadow-xl">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none opacity-20">
        ...
        <i class="fas fa-multiply absolute top-10 left-10 text-9xl animate-pulse text-white/10"></i>
        <i class="fas fa-book absolute bottom-10 right-10 text-8xl animate-spin-slow text-white/10" style="animation-duration: 12s;"></i>
    ...
    <div class="container mx-auto text-center relative z-10">
        ...
        <p class="text-lg md:text-xl text-white/90 max-w-2xl mx-auto font-light leading-relaxed mb-8">
            Mastering multiplication, division, and complex sentence structures.
        </p>
        ...
        <div class="max-w-4xl mx-auto">
            <div id="content-math" class="tab-content block animate-fade-in-up">
                <div class="prose prose-lg dark:prose-invert max-w-none">
                    <h4 class="text-xl font-bold mb-4">Core Subjects & Standards</h4><div class="space-y-4"><div><h5 class="text-lg font-bold text-primary mb-1">Math</h5><p class="text-text-secondary">Multiplication/Division within 100, area/perimeter, fractions as numbers.<br><span class="text-xs font-bold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700">CCSS.MATH.CONTENT.3.OA.A.1</span></p></div><div><h5 class="text-lg font-bold text-primary mb-1">ELA</h5><p class="text-text-secondary">Literal vs. nonliteral language, character motivation analysis.<br><span class="text-xs font-bold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700">CCSS.ELA-LITERACY.RL.3.3</span></p></div><div><h5 class="text-lg font-bold text-primary mb-1">Science</h5><p class="text-text-secondary">Force/motion balance, magnetic properties, weather over time.<br><span class="text-xs font-bold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700">NGSS: 3-PS2-1</span></p></div><div><h5 class="text-lg font-bold text-primary mb-1">Social Studies</h5><p class="text-text-secondary">Community history, economic interdependence, public records.<br><span class="text-xs font-bold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700">NCSS.D2.His.3.3-5</span></p></div></div>
                </div>
            </div>
