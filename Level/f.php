...
$pageDescription = "Multi-digit arithmetic, fraction equivalence, and structural analysis of texts.";
$pageKeywords    = "4th grade, math, fractions, decimals, reading, history";
...
<!-- Hero Section -->
<header class="relative bg-gradient-to-br from-teal-600 via-emerald-600 to-teal-700 text-white py-16 px-4 mb-12 overflow-hidden rounded-b-[2.5rem] shadow-xl">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none opacity-20">
        ...
        <i class="fas fa-square-root-alt absolute top-10 left-10 text-9xl animate-pulse text-white/10"></i>
        <i class="fas fa-microscope absolute bottom-10 right-10 text-8xl animate-spin-slow text-white/10" style="animation-duration: 12s;"></i>
    ...
    <div class="container mx-auto text-center relative z-10">
        ...
        <p class="text-lg md:text-xl text-white/90 max-w-2xl mx-auto font-light leading-relaxed mb-8">
            Multi-digit arithmetic, fraction equivalence, and structural analysis of texts.
        </p>
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="../assessment/index.php"
                class="inline-block px-8 py-3 bg-white text-teal-600 font-bold rounded-full hover:bg-gray-50 transition-colors shadow-lg transform hover:-translate-y-1">
        ...
        <div class="max-w-4xl mx-auto">
            <div id="content-math" class="tab-content block animate-fade-in-up">
                <div class="prose prose-lg dark:prose-invert max-w-none">
                    <h4 class="text-xl font-bold mb-4">Core Subjects & Standards</h4><div class="space-y-4"><div><h5 class="text-lg font-bold text-primary mb-1">Math</h5><p class="text-text-secondary">Place value for multi-digit numbers, fraction equivalence and ordering, decimal notation.<br><span class="text-xs font-bold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700">CCSS.MATH.CONTENT.4.NBT.A.1</span></p></div><div><h5 class="text-lg font-bold text-primary mb-1">ELA</h5><p class="text-text-secondary">Structural features of poems/drama vs. prose, first/third person narrators.<br><span class="text-xs font-bold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700">CCSS.ELA-LITERACY.RL.4.5</span></p></div><div><h5 class="text-lg font-bold text-primary mb-1">Science</h5><p class="text-text-secondary">Energy transfer, wave patterns, Earth's changing features over time.<br><span class="text-xs font-bold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700">NGSS: 4-PS3-1</span></p></div><div><h5 class="text-lg font-bold text-primary mb-1">Social Studies</h5><p class="text-text-secondary">Regional change, population movement, technological influences on history.<br><span class="text-xs font-bold bg-base-bg px-2 py-1 rounded inline-block mt-1 border border-gray-200 dark:border-gray-700">NCSS.D2.His.14.3-5</span></p></div></div>
                </div>
            </div>
