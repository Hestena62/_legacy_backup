...
$pageDescription = "Decimals, essay writing, ecosystems. Preparing for middle school.";
$pageKeywords    = "fifth grade, decimals, writing, ecosystems, 5th";
...
<header class="relative bg-gradient-to-br from-teal-600 via-emerald-600 to-teal-700 text-white py-16 px-4 mb-12 overflow-hidden rounded-b-[2.5rem] shadow-xl">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none opacity-20">
        ...
        <i class="fas fa-atom absolute top-10 left-10 text-9xl animate-pulse text-white/10"></i>
        <i class="fas fa-seedling absolute bottom-10 right-10 text-8xl animate-spin-slow text-white/10" style="animation-duration: 12s;"></i>
    ...
    <div class="container mx-auto text-center relative z-10">
        ...
        <p class="text-lg md:text-xl text-white/90 max-w-2xl mx-auto font-light leading-relaxed mb-8">
            Volumes, operations with decimals and mixed fractions, and complex essays.
        </p>
