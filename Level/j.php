...
$pageTitle       = "8th Grade Level J | Hesten's Learning";
$pageDescription = "Linear equations, historical analysis, and earth science. Pre-high school readiness.";
$pageKeywords    = "eighth grade, linear equations, history, pre-high, 8th";
...
<header class="relative bg-gradient-to-br from-amber-500 via-orange-500 to-amber-600 text-white py-16 px-4 mb-12 overflow-hidden rounded-b-[2.5rem] shadow-xl">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none opacity-20">
        ...
        <i class="fas fa-history absolute top-10 left-10 text-9xl animate-pulse text-white/10"></i>
        <i class="fas fa-square-root-alt absolute bottom-10 right-10 text-8xl animate-spin-slow text-white/10" style="animation-duration: 12s;"></i>
    ...
    <div class="container mx-auto text-center relative z-10">
        ...
        <p class="text-lg md:text-xl text-white/90 max-w-2xl mx-auto font-light leading-relaxed mb-8">
            Linear equations, historical analysis, and advanced physical sciences.
        </p>
