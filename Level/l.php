...
$pageTitle       = "10th Grade Level L | Hesten's Learning";
$pageDescription = "Geometry, world history, biology. Broadening academic horizons.";
$pageKeywords    = "tenth grade, sophomore, geometry, world history, 10th";
...
<header class="relative bg-gradient-to-br from-rose-600 via-pink-600 to-rose-700 text-white py-16 px-4 mb-12 overflow-hidden rounded-b-[2.5rem] shadow-xl">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none opacity-20">
        ...
        <i class="fas fa-project-diagram absolute top-10 left-10 text-9xl animate-pulse text-white/10"></i>
        <i class="fas fa-dna absolute bottom-10 right-10 text-8xl animate-spin-slow text-white/10" style="animation-duration: 12s;"></i>
    ...
    <div class="container mx-auto text-center relative z-10">
        ...
        <p class="text-lg md:text-xl text-white/90 max-w-2xl mx-auto font-light leading-relaxed mb-8">
            Geometry, world history, and advanced biology. Broadening academic horizons.
        </p>
