...
$pageTitle       = "11th Grade Level M | Hesten's Learning";
$pageDescription = "Pre-calculus, advanced literature, and chemistry. College readiness.";
$pageKeywords    = "eleventh grade, junior, chemistry, pre-calculus, 11th";
...
<header class="relative bg-gradient-to-br from-rose-600 via-pink-600 to-rose-700 text-white py-16 px-4 mb-12 overflow-hidden rounded-b-[2.5rem] shadow-xl">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none opacity-20">
        ...
        <i class="fas fa-microscope absolute top-10 left-10 text-9xl animate-pulse text-white/10"></i>
    ...
    <div class="container mx-auto text-center relative z-10">
        ...
        <p class="text-lg md:text-xl text-white/90 max-w-2xl mx-auto font-light leading-relaxed mb-8">
            Pre-calculus, advanced literature, and complex chemical systems. College prep mastery.
        </p>
...
<script>
    function switchTab(tabName) {
        ...
        btn.classList.add('active', 'rose-600', 'text-white', 'shadow-md');
